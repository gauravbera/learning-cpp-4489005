...
float StudentRecords::get_GPA(int sid) const{ //means that code inside fn cannot modify studentrecords objects
    float points = 0.0f, credits = 0.0f;
    for (const Grade& grd : grades) // declare it as const
